...
-- for creating corpus_text for training samples. The files contains overlapping text windows
cmd:option('-textwinFiles_DIR', '../../../../../../data/tokenizedFiles/TextWinFiles/',
	'text window files location')
-- for creating vocab -- word counts in TextWinFiles are more that actual
